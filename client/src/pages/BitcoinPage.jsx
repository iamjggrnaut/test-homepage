...
const BitcoinPage = () => {
    ...
    useEffect(() => {
        if(currency == 'USD'){
            ServiceFunctions.getBitcoinUsdOrderBook().then(data => setData(data))
        } else if(currency == 'EUR'){
            ServiceFunctions.getBitcoinEuroOrderBook().then(data => setData(data))
        }
    }, [currency])
    ...
    const options = {title: {text: 'Bitcoin'}, series: [{data: optionsDataAsks,}, {data: optionsDataBids}]}
